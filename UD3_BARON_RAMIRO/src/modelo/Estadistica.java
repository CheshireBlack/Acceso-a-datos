...
public class Estadistica implements java.io.Serializable {
	...
	public String toString() {
		return "\tPuntos por partido: " + puntosPorPartido + "\t\tAsistencias por partido: " +
				asistenciasPorPartido + "\t\tTapones por partido: " + 
				taponesPorPartido + "\t\tRebotes por partido: " + rebotesPorPartido + "\n";
	}
